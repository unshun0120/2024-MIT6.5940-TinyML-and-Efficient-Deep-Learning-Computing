        ...
        for (int col = 0; col < n; col += 4) {
            ...
            for (int ch = 0; ch < k;) {
                ...
                for (int qj = 0; qj < 32; qj++) {
                    ...
                    intermediate_sum1_2nd += a_int8[qj + 32] * w_de_15;

                    intermediate_sum2 += a_int8[qj] * w_de_2;
                    intermediate_sum2_2nd += a_int8[qj + 32] * w_de_14;

                    intermediate_sum3 += a_int8[qj] * w_de_3;
                    intermediate_sum3_2nd += a_int8[qj + 32] * w_de_13;
